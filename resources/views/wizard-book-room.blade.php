		            ...
		            <div class="wizard-container">
		                ...
		                <!--        You can switch " data-color="blue" "  with one of the next bright colors: "green", "orange", "red", "purple"             -->
		                    	...
		                    	<div class="wizard-header">
									...
									<h5>You have to answer all!!!</h5>
		                    	</div>
								<div class="wizard-navigation">
									<ul>
			                            <li><a href="#details" data-toggle="tab">Administrator Credentials</a></li>
			                            <li><a href="#captain" data-toggle="tab">Check Correct Field</a></li>
			                            <li><a href="#description" data-toggle="tab">Write me a letter</a></li>
			                        </ul>
								</div>
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane" id="details">
		                            	<div class="row">
			                            	<div class="col-sm-12">
			                                	<h4 class="info-text">Go ahead! Make my day!!!</h4>
			                            	</div>
		                                	<div class="col-sm-8 col-sm-offset-2">
		                            ...
		                            <div class="tab-pane" id="description">
		                                <div class="row">
		                                    <h4 class="info-text"> Drop me a letter.</h4>
		                                    ...
		                                    <div class="col-sm-4">
		                                    	<div class="form-group">
		                                            ...
		                                            <p class="description">"Something nice"</p>
		                                        </div>
		                                    </div>
		                                </div>
		                            </div>
